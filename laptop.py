...
metrics = {} #r2 and mae for each model
best_score = -999 #to track best r2
best_pipe = None #to track best pipeline
best_name = None #to track best model name
...
for name, estimator in models:
    ...
    if r2 > best_score: #track best model
        best_score = r2
